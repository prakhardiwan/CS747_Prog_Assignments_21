...
np.random.seed(inp.randomSeed)
scale = inp.scale
with open(inp.instance) as probs:
...
total_pulls = inp.horizon
eps = inp.epsilon
# Going over for pulling 

if inp.algorithm == "epsilon-greedy-t1":
    ...
    #print(total_reward)
    HIGHS = 0
elif inp.algorithm == "thompson-sampling-t1":
...
print("{}, {}, {}, {}, {}, {}, {}, {}, {}".format(inp.instance, inp.algorithm, inp.randomSeed,inp.epsilon, inp.scale, inp.threshold,inp.horizon,REG,HIGHS))
#print(REG)
#print(numArms)
#print(inp.instance)