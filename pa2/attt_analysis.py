...
def get_args():
    ...
    parser.add_argument('-player', help = 'Player who is playing the game')
...
if __name__ == '__main__':
    ...
    for i in range(100):
        np.random.seed(i)
        player_1_wins_seed = 0
        player_2_wins_seed = 0
        ...
        for j in range(50):
            ...
            DrawGrid()
            if result == 1:
                player_1_wins_seed += 1
                print("Player 1 wins")
            elif result == 2:
                player_2_wins_seed += 1
                print("Player 2 wins")
            else:
                print("Draw game")
        ...
        player_2_wins_seed = player_2_wins_seed/50
        player_1_wins_seed = player_1_wins_seed/50
        player_1_wins += player_1_wins_seed
        player_2_wins += player_2_wins_seed

    print("Number of wins of player 1: " + str(player_1_wins))
    print("Number of wins of player 2: " + str(player_2_wins))
    end_time = time.time()
